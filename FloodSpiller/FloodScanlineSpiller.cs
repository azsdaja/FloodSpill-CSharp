...
{
	/// <summary>
	/// Flood filling using scanline algorithm, where we try to mark whole vertical lines (optimized for memory access) 
	...
	public class FloodScanlineSpiller : FloodSpiller
	{
		protected override bool SpreadToNeighbours(int currentX, int currentY, int markToGive)
		{
			...
			// todo would be faster if wouldn't divide checking and processing?
